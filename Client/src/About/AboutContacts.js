            ...
            <div class="row" style={props}>
              ...
              <div class="col-md-2" style={{backgroundColor: "aliceblue"}}>
                <div class="nav flex-column nav-pills" id="" role="tablist" aria-orientation="vertical">
                  ...
                  <a class="nav-link active" id="" data-toggle="pill" href="ProspectiveGeneralInfo" role="tab">Contacts</a>
                  <a class="nav-link" id="" data-toggle="pill" href="ProspectiveWhyCS" role="tab">Facilities</a>
                  <a class="nav-link" id="" data-toggle="pill" href="ProspectiveCEGEP" role="tab">Docs</a>
                  <a class="nav-link" id="" data-toggle="pill" href="ProspectiveFreshman" role="tab">Services</a>
                </div>
              </div>
