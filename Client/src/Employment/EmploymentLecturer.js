...
class EmpolymentLecturer extends Component {
    ...
    render() { 
      ...
      <a class="nav-link active" id="" data-toggle="pill" href="#Employment/EmploymentLecturer" role="tab">Empolyment Course Lecturer</a>
      ...
      <a class="nav-link" id="" data-toggle="pill" href="#Employment/EmploymentStudents" role="tab">Empolyment Students</a>
    </div>
